...
<ul>
	<li><code>SummaryRanges()</code> Initializes the object <bvtag class="memorize_new_word bv_leetcode_com bv_browserName_google_chrome  burning_vocabulary  _id_1594940668588">with</bvtag> an empty stream.</li>
