...
<ul>
	<li>Choose a destination square <code>next</code> <bvtag class="memorize_new_word bv_leetcode_com bv_browserName_google_chrome  burning_vocabulary  _id_1594940668588">with</bvtag> a label in the range <code>[curr + 1, min(curr + 6, n<sup>2</sup>)]</code>.
