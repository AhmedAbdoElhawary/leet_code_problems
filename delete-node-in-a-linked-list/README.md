...
<strong>Explanation: </strong>You are given the second node <bvtag class="memorize_new_word bv_leetcode_com bv_browserName_google_chrome  burning_vocabulary  _id_1594940668588">with</bvtag> value 5, the linked list should become 4 -&gt; 1 -&gt; 9 after calling your function.
</pre>
...
<strong>Explanation: </strong>You are given the third node <bvtag class="memorize_new_word bv_leetcode_com bv_browserName_google_chrome  burning_vocabulary  _id_1594940668588">with</bvtag> value 1, the linked list should become 4 -&gt; 5 -&gt; 9 after calling your function.
</pre>
